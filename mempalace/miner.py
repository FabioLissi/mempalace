...
CHUNK_SIZE = int(os.environ.get("MEMPALACE_CHUNK_SIZE", 450))  # chars per drawer
CHUNK_OVERLAP = int(os.environ.get("MEMPALACE_CHUNK_OVERLAP", 50))  # overlap between chunks
